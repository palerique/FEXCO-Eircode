...
import br.com.sitedoph.fexco.postcode.domain.util.JSR310DateConverters.*;
...
@Configuration
@EnableMongoRepositories("br.com.sitedoph.fexco.postcode.repository")
...
public class CloudMongoDbConfiguration extends AbstractMongoConfiguration {
    ...
    public Mongobee mongobee() throws Exception {
        ...
        mongobee.setChangeLogsScanPackage("br.com.sitedoph.fexco.postcode.config.dbmigrations");
